...
/**
 * Servlet implementation class AdvertisementListCtl
 */
@WebServlet(name = "AdvertisementListCtl", urlPatterns = { "/ctl/advertisementList" })
public class AdvertisementListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("AdvertisementListCtl populateBean method start");
		...
		log.debug("AdvertisementListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.debug("AdvertisementListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				AdvertisementBean deletebean = new AdvertisementBean();
				for (String id : ids) {
		...
		log.debug("AdvertisementListCtl doPost method end");
	}

	@Override
	protected String getView() {
		return FPSView.ADVERTISEMENT_LIST_VIEW;
	}
