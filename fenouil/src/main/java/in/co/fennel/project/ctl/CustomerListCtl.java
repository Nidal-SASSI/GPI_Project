 ...
 */
@WebServlet(name = "CustomerListCtl", urlPatterns = { "/ctl/customerList" })
public class CustomerListCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			ServletUtility.redirect(FPSView.CUSTOMER_LIST_CTL, request, response);
			return;
	...
	protected String getView() {
		return FPSView.CUSTOMER_LIST_VIEW;
	}
