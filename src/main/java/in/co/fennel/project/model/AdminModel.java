...
import in.co.fennel.project.exception.RecordNotFoundException;
...
public class AdminModel {
	private static Logger log = Logger.getLogger(AdminModel.class);
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM F_ADMIN");
	 ...
	 * 
	 */
	public long add(AdminBean bean) throws ApplicationException, DuplicateRecordException {
		
		Connection conn = null;
		int pk = 0;

		AdminBean existbean = findByLogin(bean.getLogin());
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO F_ADMIN VALUES(?,?,?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	 ...
	 * @throws DatabaseException
	 */
	public void delete(AdminBean bean) throws ApplicationException {
		
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
			PreparedStatement pstmt = conn.prepareStatement("DELETE FROM F_ADMIN WHERE ID=?");
	...
	public AdminBean findByLogin(String login) throws ApplicationException {
		log.debug("Model findByLogin Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM F_ADMIN WHERE LOGIN=?");
		AdminBean bean = null;
		Connection conn = null;
	...
	public AdminBean findByPK(long pk) throws ApplicationException {
		log.debug("Model findByPK Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM F_ADMIN WHERE ID=?");
		AdminBean bean = null;
		Connection conn = null;
	...
	public void update(AdminBean bean) throws ApplicationException, DuplicateRecordException {
		log.debug("Model update Started");
		Connection conn = null;

		AdminBean beanExist = findByLogin(bean.getLogin());
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE F_ADMIN SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,ROLEID=?,"
	...
	public List search(AdminBean bean) throws ApplicationException {
	...
	public List search(AdminBean bean, int pageNo, int pageSize) throws ApplicationException {
		log.debug("Model search Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM F_ADMIN WHERE 1=1");
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("select * from F_ADMIN");
		// if page size is greater than zero then apply pagination
		if (pageSize > 0) {
			// Calculate start record index
			pageNo = (pageNo - 1) * pageSize;
	...
	public AdminBean authenticate(String login, String password) throws ApplicationException {
		log.debug("Model authenticate Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM F_ADMIN WHERE LOGIN = ? AND PASSWORD = ?");
		AdminBean bean = null;
		Connection conn = null;
	...
	public List getRoles(AdminBean bean) throws ApplicationException {
		log.debug("Model get roles Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM F_ADMIN WHERE roleId=?");
		Connection conn = null;
	...
	public long registerUser(AdminBean bean)
	...
	public boolean forgetPassword(String login)
		...
		AdminBean userData = findByLogin(login);
